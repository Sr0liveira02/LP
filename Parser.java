...
public class Parser implements ParserConstants {
 ...
 Token op;
  ...
  static final public ASTNode ListExp() throws ParseException {
  ASTNode head, tail;
    head = Term();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case LIST:
    case LAZYLIST:
      ...
      case LIST:
        ...
        tail = ListExp();
                              head = new ASTList(head, tail);
        break;
      case LAZYLIST:
        jj_consume_token(LAZYLIST);
        tail = ListExp();
                                  head = new ASTLazyList(head, tail);
        break;
      default:
        jj_la1[11] = jj_gen;
        jj_consume_token(-1);
 ...
 Token op;
  ...
  List<String> params = new ArrayList<String>();
    ...
    case MATCH:
      ...
      jj_consume_token(MATCHARROW);
      e1 = Let();
      jj_consume_token(MATCHOR);
      n = jj_consume_token(Id);
      jj_consume_token(LIST);
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x80005dc1,0x40,0x80005dc0,0x100000,0x0,0x1000000,0x800000,0x7e000000,0x7e000000,0x600,0x600,0x0,0x0,0x6800,0x6800,0x400000,0x80005d80,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x312f6,0x0,0x312f6,0x0,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0xc00,0xc00,0x0,0x0,0x0,0x312f6,};
   }
