...
ASTType at;
  ...
  ASTType at = null;
    ...
    case Label:
      ...
      e1 = Fact();
      jj_consume_token(RPAR);
                                            struct.add(new Bind(n.image, at, e1)); t = new ASTUnion(struct);
      break;
    case LBRA:
      jj_consume_token(LBRA);
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case Label:
        ...
        jj_consume_token(EQUAL);
        e1 = Fact();
                                                struct.add(new Bind(n.image, at, e1));
        label_9:
        while (true) {
          switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
          case COMMA:
    ...
    case MATCH:
      ...
      case Label:
        ...
        jj_consume_token(SARROW);
        e1 = Let();
                                                                statements.add(new MatchStatement(n.image, n1.image, e1));
        label_10:
        while (true) {
          switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
          case PIPE:
          ...
          jj_consume_token(PIPE);
          m = jj_consume_token(Label);
          jj_consume_token(LPAR);
          m1 = jj_consume_token(Id);
          jj_consume_token(RPAR);
          jj_consume_token(SARROW);
          e2 = Let();
                                                                        statements.add(new MatchStatement(m.image, m1.image, e2));
        }
        jj_consume_token(RBRA);
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x293c1,0xc0,0x200000,0xc0,0x1000000,0x0,0x10000000,0x8000000,0xe0000000,0xe0000000,0x1800,0x1800,0xc00000,0x10e000,0x10e000,0xc00000,0x4000000,0x4000000,0x0,0x400,0x0,0x29300,0x0,0x4000000,0x0,0x8000,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x1e053de8,0x0,0x0,0x0,0x0,0x10,0x0,0x0,0x7,0x7,0x0,0x0,0x0,0x40000,0x40000,0x0,0x0,0x0,0x8000000,0x0,0x8000040,0x1e053de8,0x8000,0x0,0x8000000,0x5fe0000,};
   }
